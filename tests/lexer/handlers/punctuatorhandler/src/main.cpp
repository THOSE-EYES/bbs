...
/**
 * @brief Test fixture class for the PunctuatorHandler component testing
 * 
 */
class PunctuatorHandlerTest : public ::testing::Test
{
protected:
	/**
...
protected:
	 ...
	 * 
	 */
	lexer::handlers::PunctuatorHandler instance_;
};
 ...
 * 
 */
TEST_F(PunctuatorHandlerTest, TestProcessNullopt)
{
	using ::testing::_;
 ...
 * 
 */
TEST_F(PunctuatorHandlerTest, TestProcessNextNullptr)
{
	using ::testing::_;
